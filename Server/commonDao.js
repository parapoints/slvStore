    ...
    inportCSV(data){
       ...
       // if(connection == true){
        ...
        console.log(product.product_id)
            var connection = this.connectToDB();
            var records =[product.product_name,product.product_price,product.product_quantity,product.product_id];
            return new Promise(function(resolve, reject){
                connection.query(
                    "UPDATE product_catalog SET product_name =?,product_price =?,product_quantity =? WHERE product_id =?"
                    ,records,
                    function(err, rows){
                        console.log(err);
                        if(rows === undefined){
